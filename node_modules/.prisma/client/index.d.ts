  ...
  */
  ...
  export type DeliverymanGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        P extends 'Deliveries' ? Array < DeliveriesGetPayload<S['include'][P]>>  :
        P extends '_count' ? DeliverymanCountOutputTypeGetPayload<S['include'][P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'Deliveries' ? Array < DeliveriesGetPayload<S['select'][P]>>  :
  ...
  export interface DeliverymanDelegate<GlobalRejectSettings> {
    /**
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Deliveryman'> extends True ? CheckSelect<T, Prisma__DeliverymanClient<Deliveryman>, Prisma__DeliverymanClient<DeliverymanGetPayload<T>>> : CheckSelect<T, Prisma__DeliverymanClient<Deliveryman | null >, Prisma__DeliverymanClient<DeliverymanGetPayload<T> | null >>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Deliveryman'> extends True ? CheckSelect<T, Prisma__DeliverymanClient<Deliveryman>, Prisma__DeliverymanClient<DeliverymanGetPayload<T>>> : CheckSelect<T, Prisma__DeliverymanClient<Deliveryman | null >, Prisma__DeliverymanClient<DeliverymanGetPayload<T> | null >>
   ...
   */
  export class Prisma__DeliverymanClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    ...
    Deliveries<T extends DeliveriesFindManyArgs = {}>(args?: Subset<T, DeliveriesFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Deliveries>>, PrismaPromise<Array<DeliveriesGetPayload<T>>>>;
   ...
   */
  export type DeliverymanFindUniqueArgs = {
    /**
    ...
    **/
    ...
    /**
     * Throw an Error if a Deliveryman can't be found
     * 
    **/
   ...
   */
  export type DeliverymanFindFirstArgs = {
    /**
     * Select specific fields to fetch from the Deliveryman
     * 
    **/
  ...
  export type DeliveriesGetPayload<
    ...
    ? Deliveries  & {
    [P in TrueKeys<S['include']>]:
        P extends 'client' ? ClientsGetPayload<S['include'][P]> :
        P extends 'deliveryman' ? DeliverymanGetPayload<S['include'][P]> | null :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'client' ? ClientsGetPayload<S['select'][P]> :
        P extends 'deliveryman' ? DeliverymanGetPayload<S['select'][P]> | null :  P extends keyof Deliveries ? Deliveries[P] : never
  } 
    : Deliveries
  : Deliveries
  ...
  export interface DeliveriesDelegate<GlobalRejectSettings> {
    /**
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Deliveries'> extends True ? CheckSelect<T, Prisma__DeliveriesClient<Deliveries>, Prisma__DeliveriesClient<DeliveriesGetPayload<T>>> : CheckSelect<T, Prisma__DeliveriesClient<Deliveries | null >, Prisma__DeliveriesClient<DeliveriesGetPayload<T> | null >>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Deliveries'> extends True ? CheckSelect<T, Prisma__DeliveriesClient<Deliveries>, Prisma__DeliveriesClient<DeliveriesGetPayload<T>>> : CheckSelect<T, Prisma__DeliveriesClient<Deliveries | null >, Prisma__DeliveriesClient<DeliveriesGetPayload<T> | null >>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__DeliveriesClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
   ...
   */
  export type DeliveriesFindUniqueArgs = {
    /**
    ...
    **/
    ...
    /**
     * Throw an Error if a Deliveries can't be found
     * 
    **/
    rejectOnNotFound?: RejectOnNotFound
    /**
   ...
   */
  export type DeliveriesFindFirstArgs = {
    /**
     * Select specific fields to fetch from the Deliveries
     * 
    **/
  ...
  export type DeliveriesScalarWhereWithAggregatesInput = {
    ...
    id_deliveryman?: StringNullableWithAggregatesFilter | string | null
    item_name?: StringWithAggregatesFilter | string
    created_at?: DateTimeWithAggregatesFilter | Date | string
    end_at?: DateTimeNullableWithAggregatesFilter | Date | string | null
  }
  ...
  export type DeliverymanUpdateInput = {
    ...
    Deliveries?: DeliveriesUpdateManyWithoutDeliverymanInput
  }
  ...
  export type DeliverymanUncheckedUpdateInput = {
    ...
    username?: StringFieldUpdateOperationsInput | string
    password?: StringFieldUpdateOperationsInput | string
    Deliveries?: DeliveriesUncheckedUpdateManyWithoutDeliverymanInput
  }
  ...
  export type ClientsUpdateInput = {
    ...
    username?: StringFieldUpdateOperationsInput | string
    password?: StringFieldUpdateOperationsInput | string
    Deliveries?: DeliveriesUpdateManyWithoutClientInput
  }
  ...
  export type ClientsUncheckedUpdateInput = {
    ...
    username?: StringFieldUpdateOperationsInput | string
    password?: StringFieldUpdateOperationsInput | string
    Deliveries?: DeliveriesUncheckedUpdateManyWithoutClientInput
  }
  ...
  export type DeliveriesUpdateInput = {
    id?: StringFieldUpdateOperationsInput | string
    client?: ClientsUpdateOneRequiredWithoutDeliveriesInput
    deliveryman?: DeliverymanUpdateOneWithoutDeliveriesInput
  ...
  export type DeliveriesUpdateManyWithoutDeliverymanInput = {
    create?: XOR<Enumerable<DeliveriesCreateWithoutDeliverymanInput>, Enumerable<DeliveriesUncheckedCreateWithoutDeliverymanInput>>
    connectOrCreate?: Enumerable<DeliveriesCreateOrConnectWithoutDeliverymanInput>
  ...
  export type DeliveriesUpdateManyWithoutClientInput = {
    create?: XOR<Enumerable<DeliveriesCreateWithoutClientInput>, Enumerable<DeliveriesUncheckedCreateWithoutClientInput>>
    connectOrCreate?: Enumerable<DeliveriesCreateOrConnectWithoutClientInput>
  ...
  export type ClientsUpdateOneRequiredWithoutDeliveriesInput = {
    create?: XOR<ClientsCreateWithoutDeliveriesInput, ClientsUncheckedCreateWithoutDeliveriesInput>
    connectOrCreate?: ClientsCreateOrConnectWithoutDeliveriesInput
  ...
  export type DeliverymanUpdateOneWithoutDeliveriesInput = {
    create?: XOR<DeliverymanCreateWithoutDeliveriesInput, DeliverymanUncheckedCreateWithoutDeliveriesInput>
    connectOrCreate?: DeliverymanCreateOrConnectWithoutDeliveriesInput
